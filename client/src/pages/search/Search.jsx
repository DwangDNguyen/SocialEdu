...
import { video, user, post } from "../../redux/axios/axios";
...
const Search = () => {
    ...
    useEffect(() => {
        const fetchSearch = async () => {
            ...
            const resBlog = await post.get("/search", {
                params: {
                    q: String(q),
                },
            });
            const resUser = await user.get("/search", {
                params: {
                    q: String(q),
                },
            });
            setUserSearchResult(resUser.data);
            setSearchResult(res.data);
            setBlogSearchResult(resBlog.data);
            setLoading(false);
        };
        fetchSearch();
    }, [q]);
    ...
    return (
        <div className={loading ? "search-page spokes" : "search-page"}>
            {loading ? (
                ...
                <>
                    <h1>
                        {t("search.Filter for search") + " " + "'" + q + "'"}
                    </h1>
                    <div
                        className={
                            searchResult.length < 1
                                ? `search-container video-null`
                                : `search-container`
                        }
                    >
                        <div className="title search-category">User</div>
                            ...
                            <div className="no-result">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        ></path>
                                        <g
                                            clipPath="url(#empty_search__clip-path)"
                                            className="style-scope yt-icon"
                                        >
                                            <path
                                                fill="#ffd61d"
                                            ...
                                            <path
                                                fill="#ffc100"
                                                d="M157.43 110.27h27.2v8.57h-27.2z"
                                                className="style-scope yt-icon"
                                            ></path>
                                            <path
                                                fill="#ffd61d"
                                            ...
                                            <path
                                                fill="#ffc100"
                                                d="M144.34 12.19h20.87v17.99h-20.87z"
                                                className="style-scope yt-icon"
                                            ></path>
                                            <path
                                                fill="#ffd61d"
                                        ...
                                        <path
                                            fill="#6f38d4"
                                            d="M47.35 90.19h1.72v3.17h-1.72z"
                                            className="style-scope yt-icon"
                                        ></path>
                                        <path
                                            fill="#4620ae"
                                ...
                                <h3>{t("search.No results found")}</h3>
                                <span className="not-found-text">
                                    {t(
                                        "search.Try different keywords or remove search filters"
                                    )}
                                </span>
                            </div>
                        ) : (
                            userSearchResult?.map((userSearch, index) => {
                                return (
                                    <UserSearchItem
                        ...
                        <div className="title search-category">Video</div>
                        {searchResult.length < 1 ? (
                            <div className="no-result">
                                <svg
                                    viewBox="0 0 230 130"
                            ...
                            searchResult?.map((videoSearch, index) => {
                                return (
                                    <SearchItems
                        ...
                        <div className="title search-category">Blog</div>
                        {blogSearchResult.length < 1 ? (
                            <div className="no-result">
                                <svg
                                    viewBox="0 0 230 130"
                                    preserveAspectRatio="xMidYMid meet"
                            ...
                            blogSearchResult?.map((postSearch, index) => {
                                return (
                                    <PostItems
                        ...
                        {/* {searchResult?.map((videoSearch, index) => {
                    return (
                        <SearchItems videoSearch={videoSearch} key={index} />
                    );
                })} */}
                    </div>
                </>
